                                ...
                                <div class="ml-auto d-flex align-items-center">
                                    <nav>
                                        <ol class="breadcrumb p-0 m-b-0">
                                            ...
                                            <li class="breadcrumb-item active text-primary" aria-current="page">Payment-Form</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <div class="card card-statistics">
                            ...
                            <div class="card-body">
                                <form id="crops" action="{{ route("crops_payment.store") }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="test_count">test_count</label>
                                        <div class="mb-2">
                                            <input type="text" class="form-control" id="test_count" name="test_count" placeholder="Test Quantity" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label" for="SOIL-ID">total_price</label>
                                        <div class="mb-2">
